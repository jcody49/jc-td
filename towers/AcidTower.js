    ...
    constructor(opts = {}) {
        super({
            ...
            levelData: {
                ...
                3: { damage: 102, range: 120, fireRate: 78, dotDuration: 465, dotDamage: 485, sprite: "acid-tower3.png" },
                4: { damage: 127, range: 120, fireRate: 75, dotDuration: 400, dotDamage: 640, sprite: "acid-tower4.png" },
                5: { damage: 840, range: 120, fireRate: 71, dotDuration: 280, dotDamage: 2905, sprite: "acid-tower5.png" }
            },
            opts
        });
    }
