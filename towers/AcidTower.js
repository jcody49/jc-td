...
export class AcidTower extends Tower {
    constructor(opts = {}) {
        super({
            ...
            levelData: {
                1: { damage: 15, range: 120, fireRate: 85, dotDuration: 580, dotDamage: 37, sprite: "acid-tower.png" },
                2: { damage: 20, range: 120, fireRate: 83, dotDuration: 620, dotDamage: 50, sprite: "acid-tower2.png" },
